# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/config.default.ipynb.

# %% auto 0
__all__ = ['config', 'AttrDict', 'merge_dicts', 'cfg_from_file', 'cfg_from_list', 'update_config']

# %% ../../nbs/config.default.ipynb 3
import datetime
from loguru import logger
from yaml.loader import BaseLoader

# %% ../../nbs/config.default.ipynb 4
class AttrDict(dict):
    """
