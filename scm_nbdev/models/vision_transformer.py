# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/models.vision_transformer.ipynb.

# %% auto 0
__all__ = ['default_cfgs', 'Mlp', 'Attention', 'Block', 'PatchEmbed', 'HybridEmbed', 'VisionTransformer', 'vit_small_patch16_224',
           'vit_base_patch16_224', 'vit_base_patch16_384', 'vit_base_patch32_384', 'vit_large_patch16_224',
           'vit_large_patch16_384', 'vit_large_patch32_384', 'vit_huge_patch16_224', 'vit_huge_patch32_384',
           'vit_small_resnet26d_224', 'vit_small_resnet50d_s3_224', 'vit_base_resnet26d_224', 'vit_base_resnet50d_224']

# %% ../../nbs/models.vision_transformer.ipynb 3
import torch
...
# %% ../../nbs/models.vision_transformer.ipynb 4
def _cfg(url='', **kwargs):
    return {
        'url': url,
...
# %% ../../nbs/models.vision_transformer.ipynb 5
class Mlp(nn.Module):
