# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/models.conformer.ipynb.

# %% auto 0
__all__ = ['Mlp', 'Attention', 'Block', 'ConvBlock', 'FCUDown', 'FCUUp', 'Med_ConvBlock', 'ConvTransBlock', 'Conformer',
           'Encoder', 'norm_cam', 'embeddings_to_cosine_similarity_matrix', 'conformer_scm_small_patch16']

# %% ../../nbs/models.conformer.ipynb 3
# -----------------------------------------------------------------------------------------------------
# TS-CAM using Conformer as backbone is implemented based on https://github.com/pengzhiliang/Conformer
# -----------------------------------------------------------------------------------------------------

# %% ../../nbs/models.conformer.ipynb 4
import torch
