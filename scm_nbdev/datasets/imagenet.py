# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/datasets.imagenet.ipynb.

# %% auto 0
__all__ = ['get_transforms', 'ImageNetDataset']

# %% ../../nbs/datasets.imagenet.ipynb 3
import os
import cv2
import torch
import numpy as np
