# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/core.lr_scheduler.ipynb.

# %% auto 0
__all__ = ['LRScheduler', 'cos_lr', 'warm_cos_lr', 'yolox_warm_cos_lr', 'yolox_semi_warm_cos_lr', 'multistep_lr']

# %% ../../nbs/core.lr_scheduler.ipynb 3
import math
from functools import partial

# %% ../../nbs/core.lr_scheduler.ipynb 4
class LRScheduler:
    def __init__(self, name, lr, iters_per_epoch, total_epochs, **kwargs):
        """
        Supported lr schedulers name: [cos, warmcos, multistep]
